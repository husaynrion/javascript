...
var a = prompt ("what is your favourite number?");
document.write(a);
...
while (a>=1) {
 ...
 var a=10;
  ...
  for (var a=1; a<=10; a++){
    ...
    var arr = [
        ["fahim","rasel","zain","sakib"],
        ["alif","rasel","zain","sakib"],
        ["rakib","rasel","18","sakib"],
        ["sayem","rasel","zain","sakib"],
    ]
    for(var a=0;a<4;a++){
